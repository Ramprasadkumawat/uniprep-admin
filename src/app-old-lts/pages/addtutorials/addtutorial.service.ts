...
export class AddtutorialService {
  ...
  addtutorials(val: any):Observable<any> {
    ...
    formData.append("usertype",val.usertype);
    return this.http.post<any>(environment.ApiUrl+'/AddTutorial',formData, {
      headers: headers,
  });
  }
  edittutorials(val: any):Observable<any> {
    ...
    formData.append("usertype",val.usertype);
    return this.http.post<any>(environment.ApiUrl+'/EditTutorial',formData, {
      headers: headers,
  });
  }
  ...
  deleteTutorial(val: any):Observable<any> {
    const headers= new HttpHeaders()
    .set('Accept', "application/json")
    return this.http.post<any>(environment.ApiUrl+'/DeleteTutorial',val, {
      headers: headers,
  });
  }
}
