      ...
      next: (res) => {
        ...
        if (res) {
          ...
          this.activeSubscribedEmployers =
            ...
            this.totalActiveJobsPercentage = res.data.total_active_jobs_percentage || 0;
            this.totalApplicantsPercentage = res.data.total_applicants_percentage || 0;
            this.totalActiveSubscriptionsPercentage = res.data.total_active_subscriptions_percentage || 0;
