...
export class PostAdmissionComponent implements OnInit {
  ...
  totalQuizCount: any;
  quizList: any[] = [];
  currentModuleName = 'Post-Admission'
  ...
  constructor(private quizService: QuizService, private fb: FormBuilder,
              private service: LocationService, private toast: MessageService,private el: ElementRef) {
  }
  pageSize = 8;
  ngOnInit(): void {
  ...
  onInputChange(event: Event) {
    ...
    this.el.nativeElement.value = this.capitalizeFirstLetter(input);
  }
