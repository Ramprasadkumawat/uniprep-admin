...
@Component({
    selector: 'uni-language-hub-submodule',
    templateUrl: './language-hub-submodule.component.html',
    styleUrls: ['./language-hub-submodule.component.scss'],
    standalone: false
})
export class LanguageHubSubmoduleComponent implements OnInit {
    moduleId: number = 8;
    form: FormGroup;
