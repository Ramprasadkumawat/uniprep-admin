...
@Component({
    selector: 'uni-entreprenuerproficiencytest',
    templateUrl: './entreprenuerproficiencytest.component.html',
    styleUrls: ['./entreprenuerproficiencytest.component.scss'],
    imports: [
...
export class EntreprenuerproficiencytestComponent implements OnInit {
