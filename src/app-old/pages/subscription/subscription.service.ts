...
export class SubscriptionService {
  ...
  addSubscriptionPlan(params: SubscriptionParams): Observable<any>  {
    return this.http.post<SubscriptionPlanSuccessResponse>(`${environment.ApiUrl}/addsubscriptionplan`, params);
  }
  editSubscriptionPlan(params: SubscriptionParams): Observable<any>  {
    return this.http.post<SubscriptionPlanSuccessResponse>(`${environment.ApiUrl}/editsubscriptionplan`, params);
  }
